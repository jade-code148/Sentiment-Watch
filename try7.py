...
# Define API keys
ALPHA_VANTAGE_API_KEY = "7UU6PZTGN7LHMB0O"
NEWSAPI_API_KEY = "86a7bb4748374892af3d34531bb610fe"
...
def load_css():
    title_bg_image_file = 'c:\\Users\\Jayden\\project\\stock.png'
...
def load_html():
    with open("c:\\Users\\Jayden\\project\\index.html") as f:
...
with col1:
    ...
    if fetch_data_button:
        with st.spinner('Fetching data and news...'):
            # Fetch stock data
            data = fetch_stock_data("7UU6PZTGN7LHMB0O", symbol, function, interval)
            df = process_data(data, function)

            # Fetch news data
            news_data = fetch_news('86a7bb4748374892af3d34531bb610fe', symbol, num_articles)
        ...
        with st.expander("Click here for news articles"):
            for article in news_data['articles']:
                ...
                if transformers_available:
                    ...
                    st.markdown(f"**RoBERTa Sentiment**: {roberta_sentiment[0]}")
